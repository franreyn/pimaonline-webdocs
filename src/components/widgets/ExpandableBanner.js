  ...
  return (
    <section className="wd-content" id="toc-expandable-banner">
      ...
      <ol className="numbered-list">
        <li>An image with <span className="wd-monospace">no description</span>.</li>
        <li>An image that uses the <span className="wd-monospace">alt text as the description</span>. Alt text should be <span className="wd-monospace">short and concise</span>. If the description is longer and more detailed, use the next option.</li>
        <li>An image with a <span className="wd-monospace">detailed description</span> that uses the <span className="wd-monospace">data-description attribute</span>.</li>
      </ol>
