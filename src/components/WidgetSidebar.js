...
export default function WidgetSidebar() {
  ...
  const sections = useRef([
    'toc-accordion', 'toc-assignments', 'toc-blockquote', 'toc-border', 'toc-call-out', 'toc-flip-card', 'toc-card-horizontal', 
    'toc-horizontal-display', 'toc-img-gallery', 'toc-locked-content', 'toc-media-container', 'toc-side-by-side', 'toc-tables', 
    'toc-tabs', 'toc-video-widget', 'toc-vocab-cards', 'toc-vocab-list'
  ]);
        ...
        <li className={router.pathname === '/widgets' ? 'active-page' : ''}><Link href="/widgets">Widgets</Link>
          <ul>
            <li className={activeId === 'toc-accordion' ? 'is-current' : ''}>
              <Link href="/widgets/#accordion" className="toc-accordion">Accordion</Link>
            </li>
            <li className={activeId === 'toc-assignments' ? 'is-current' : ''}>
              <Link href="/widgets/#assignments" className="toc-assignments">Assignments Widget</Link>
            </li>
            <li className={activeId === 'toc-blockquote' ? 'is-current' : ''}>
              <Link href="/widgets/#blockquote" className="toc-blockquote">Blockquote</Link>
            </li>
            <li className={activeId === 'toc-border' ? 'is-current' : ''}>
              <Link href="/widgets/#border" className="toc-border">Border</Link>
            </li>
            ...
            <li className={activeId === 'toc-img-gallery' ? 'is-current' : ''}>
              <Link href="/widgets/#img-gallery" className="toc-img-gallery">Image Gallery</Link>
            </li>
            <li className={activeId === 'toc-locked-content' ? 'is-current' : ''}>
              <Link href="/widgets/#locked-content" className="toc-locked-content">Locked Content</Link>
            </li>
            <li className={activeId === 'toc-media-container' ? 'is-current' : ''}>
              <Link href="/widgets/#media-container" className="toc-media-container">Media Container</Link>
            </li>
            <li className={activeId === 'toc-side-by-side' ? 'is-current' : ''}>
              <Link href="/widgets/#side-by-side" className="toc-side-by-side">Side-by-side</Link>
            </li>
            <li className={activeId === 'toc-tables' ? 'is-current' : ''}>
              <Link href="/widgets/#tables" className="toc-tables">Tables</Link>
            </li>
            <li className={activeId === 'toc-tabs' ? 'is-current' : ''}>
              <Link href="/widgets/#tabs" className="toc-tabs">Tabs</Link>
            </li>
            <li className={activeId === 'toc-video-widget' ? 'is-current' : ''}>
              <Link href="/widgets/#video-widget" className="toc-video-widget">Video Widget</Link>
            </li>
            <li className={activeId === 'toc-vocab-cards' ? 'is-current' : ''}>
              <Link href="/widgets/#vocab-cards" className="toc-vocab-cards">Vocab Cards</Link>
            </li>
            <li className={activeId === 'toc-vocab-list' ? 'is-current' : ''}>
              <Link href="/widgets/#vocab-list" className="toc-vocab-list">Vocab List</Link>
            </li>
          </ul>
        </li>
      </ul>
