        ...
        <div className="wd-visual-ex">
          <section className="wd-side-by-side">
            <div className="wd-side-by-side-item">
              <Image src="/images/plugins/VO-mouse-highlight.png" alt="page with mouse highlight view option open" width={292} height={280} priority="true" />
            </div>
            <div className="wd-side-by-side-item">
              <Image src="/images/plugins/VO-mouse-highlight-on.png" alt="page with mouse highlight view option active" width={292} height={280} />
            </div>
          </section>
          </div>
