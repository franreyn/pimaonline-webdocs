  ...
  return (
    <>
      <div className="wd-content-wrapper">
        <div class="wd-header">
          <Image className="box-svg" src="/images/box.svg" alt="" width={166} height={252} />
        ...
        <Image className="hex-svg" src="/images/hex.svg" alt="" width={100} height={166} />
        <div className="wd-content-body">
          ...
          <div class="wd-img-wrap mb-12">
            <Image className="wd-preview-img" src="/images/theme-2.png" alt="" width={250} height={150} />
            <Image className="wd-preview-img" src="/images/theme-1.png" alt="" width={400} height={250} />
            <Image className="wd-preview-img" src="/images/theme-3.png" alt="" width={250} height={150} />
          </div>
          <div class="wd-btn-center">
            <Link className="wd-btn" href={"getting-started.html"}>Explore Themes</Link>
          </div>
        </div>
        <div className="wd-content-body wd-grid">
          ...
          <Image className="wave" src="/images/wave.svg" alt="" width={1440} height={727} />
        </div>
        <div className="wd-content-body wd-reverse-grid">
          <div class="wd-text-container">
