      ...
      <div className="wd-grid">
        <main>
          ...
          <section className="template-section">
            ...
            <div>
            <Link href="/templates/OneColumn2"><Image src="/images/templates/onecolumn2.jpg" alt="" width={292} height={280} /></Link>
              <div>
            ...
            <div>
            <Link href="/templates/OneColumn3"><Image src="/images/templates/onecolumn3.jpg" alt="" width={292} height={280} /></Link>
              <div>
            ...
            <div>
            <Link href="/templates/OneColumn4"><Image src="/images/templates/onecolumn4.jpg" alt="" width={292} height={280} /></Link>
              <div>
                <h3>Clean Grids</h3>
            ...
            <div>
            <Link href="/templates/OneColumn5"><Image src="/images/templates/onecolumn5.jpg" alt="" width={292} height={280} /></Link>
              <div>
            ...
            <div>
            <Link href="/templates/OneColumn6"><Image src="/images/templates/onecolumn6.jpg" alt="" width={292} height={280} /></Link>
              <div>
          ...
          <div>
          <Link href="/templates/TwoColumn1"><Image src="/images/templates/twocolumn2.jpg" alt="" width={292} height={280} /></Link>            <div>
              <h3>Warm Welcome</h3>
          ...
          <div>
          <Link href="/templates/TwoColumn1"><Image src="/images/templates/twocolumn3.jpg" alt="" width={292} height={280} /></Link>            <div>
          ...
          <div>
          <Link href="/templates/TwoColumn1"><Image src="/images/templates/twocolumn4.jpg" alt="" width={292} height={280} /></Link>            <div>
          ...
          <div>
          <Link href="/templates/TwoColumn1"><Image src="/images/templates/twocolumn5.jpg" alt="" width={292} height={280} /></Link>            <div>
          ...
          <div>
          <Link href="/templates/TwoColumn1"><Image src="/images/templates/twocolumn6.jpg" alt="" width={292} height={280} /></Link>            <div>
          ...
          <div>
          <Link href="/templates/SOW2"><Image src="/images/templates/sow2.jpg" alt="" width={292} height={280} /></Link>            <div>
